    ...
    return (
      <Modal show={show} onHide={handleClose}>
        <Modal.Header closeButton>
          <Modal.Title><h3 id="tituloAprendoCasa">Acerca de</h3></Modal.Title>
        </Modal.Header>
        <Modal.Body>
            ...
            <div className="col-sm-12">
              ...
              <div className="row text-left">
                <div className="col-sm-12">
                  ...
                  <p> Hernández Conejo Patricia, asesora nacional de informática </p>
                  <p> Pérez Ramírez Óscar, asesor nacional de informática </p>
                  <p> Araya Salazar Ana Teresa, asesora nacional de informática </p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="row text-center">
            <div className="col-sm-12">
              <img className="img-fluid" src="https://recursos.mep.go.cr/2020/oscar/traductor/imagenes/banner_gespro.gif" alt="Guía televisiva"></img>
              ...
              {plataforma === "movil" ? (
                <React.Fragment>
                  <div className="row">
                    <div className="col-12">
                      <img id="btn-acercaDe" className="img-fluid movil" src={imgGenerales + "acercade-02.png"} alt="Acerca de" onClick={handleShow} />
                ...
                (
                  <React.Fragment>
                    <div className="row">
                      <div className="col-12">
                        <img id="btn-acercaDe" className="img-fluid" src={imgGenerales + "acercade-02.png"} alt="Acerca de" onClick={handleShow} />
