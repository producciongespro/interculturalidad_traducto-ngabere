        ...
        <div className="col-9" id="detalleMovil"> 
            ...
            <div className="row" >              
            {
                ...
                (
                    <React.Fragment> 
                    <div className="col-12">
                         <p alt={props.info.t_espanol} className="espanolMovil">  {props.info.t_espanol}</p>                  
                        ...
                        <p alt={props.info.texto_espanol}  className="textos_espanolMovil">
                            ...
                            <div className="text-center">
                                <img className="img-fluid imgMovil" id="" src={imgGenerales + props.info.url_imagen}  alt={props.info.t_espanol} />
                            </div>
                            {
                            ...
                            (
                                <React.Fragment>
                                    <div className="text-center"><br/>
                                         <img alt="Sin audio"  className="img-fluid ico-audio" id="" src={imgGenerales + "/subidos/imagenes/no_audio.png"}  alt="Sin audio" />
                                    </div>
